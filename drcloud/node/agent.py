...
class Agent(object):
    ...
    def __init__(self, service=None, spools=spools, conf=conf, lifetime=None):
        self.inbox = {}
        self.sent = {}
        self.pending = []
        self.spools = spools
...
class Config(Model):
    channel = ModelType(channel.Config())
    lifetime = IntType(min_value=1, max_value=86400)
...
class Handler(object):
    ...
    """
    def __init__(self, envelope, q, qlock, timeout=Agent.timeout):
        self.q = q
        self.qlock = qlock
